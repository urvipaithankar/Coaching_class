...
<?php
$query = "INSERT INTO `student` (`Login_ID`,`First_Name`,`Fathers_Name`, `Surname`, `Gender`, `Birthdate` ,`Phone_No`, `Email_Id`, `Address1`, `Area`, `City`, `Pincode`,`College_Name`,`SSC_Marks`, `Entrance_Marks`, `Course`, ` Batch_ID`, `Fathers_No`, `Mothers_Name` , `Mothers_No`)
VALUES ('$Login_ID','$First_Name', '$Fathers_Name', '$Surname','$Gender', '$Birthdate','$Phone_No', '$Email_Id', '$Address1', '$Area', '$City', '$Pincode', '$College_Name' , '$SSC_Marks','$Entrance_Marks', '$Course', '$Batch_ID', '$Fathers_No' , '$Mothers_Name' , '$Mothers_No')";
